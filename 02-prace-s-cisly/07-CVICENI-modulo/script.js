...
*/
//let delitelne = Number(prompt('Zadej cislo'));
//if (delitelne % 7 === 0) {
//    console.log('True');
//} else {
//    console.log('False');
...
Představte si obyčejné ručičkové hodiny, které mají 12 pozic a ukazují 0-11 hodin. 

(Pro zjednodušení dvanáctku bereme jako 0 hodin). Když je 9 hodin, ukazuje ručička na devítku.
 Když je 15 hodin, ukazuje ručička na trojku.

Nechte uživatele zadat, kolik je hodin (jako celé číslo), a do konzoly vypiš
te, 
na jakou číslici ukazuje hodinová ručička.
*/
...
Nechte uživatele pomocí `prompt()` zadat částku. 
Zjistěte, jak mu můžete částku vydat, abyste mu dali co nejméně bankovek 
(tj. co nejvíc tisícovek, pak pětiskovku, dvoustovky, stovky a zbytek drobných).
